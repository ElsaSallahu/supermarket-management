    ...
    <CRow>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              in there. Shown below are image styles, blocks, text styles, and a list groupâ€”all
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              You can instantly change the text arrangement of any cardâ€”in its whole or specific
              partsâ€”with{' '}
